...
export default function Footer() {
  ...
  return (
    <footer className="bg-bg-secondary/80 backdrop-blur-xl border-t border-border-glass mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #4F46E5, #3B82F6)' }}>
                <FaBrain className="text-white" />
              </div>
              <h3 className="font-bold text-lg text-text-main">Smart Tutor AI</h3>
            </div>
          ...
          {/* Quick Navigation */}
          <div>
            <h4 className="font-semibold text-text-main mb-4">Quick Navigation</h4>
        ...
        {/* Social Links */}
        <div className="flex justify-center gap-6 mb-6 pb-6 border-b border-border-glass">
          <a
        ...
        <div className="text-center">
          <p className="text-sm text-text-muted flex items-center justify-center gap-1">
            Developed by <span className="font-semibold text-primary">Sankalp</span> with
